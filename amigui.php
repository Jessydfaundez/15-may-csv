...
$csv = array_map('str_getcsv', file('https://raw.githubusercontent.com/paulagunsche/clase_15_mayo/master/datos.csv'));
...
for($a = 0; $a < $total = count($csv); $a++){?>
  <article class="row">
    ...
    <div class="col-sm-12">
      ...
      <div><img src="<?php echo $csv[$a]['images'];?>" class="img-responsive"></div>
      ...
      <p><strong>Vínculo: </strong><?php echo $csv[$a]['vinculo'];?></p>
    </div>
  </article>
<?php };?>
